function initMap() {
    ...
    markers.sort(function (a, b) { return a.locationName.localeCompare(b.locationName); });
    var centerMap = { lat: 43.7854555, lng: -79.1888985 };
    var mapOptions = {
        center: centerMap,
        zoom: 16,
    ...
    var _loop_1 = function (i) {
        ...
        var infoWindowContent = "\n            <div class=\"feh-content\">\n                <h3>".concat(markers[i]['locationName'], "</h3>\n                <address>\n                    <p>").concat(markers[i]['description'], "</p>\n                </address>\n            </div>\n        ");
